...
// --------------------------------------------------------------------------------
    ...
    #define XSEC_EXPORT __attribute__ ((visibility("default"))) XERCES_PLATFORM_EXPORT
  #else
    #define XSEC_EXPORT __attribute__ ((visibility("default"))) XERCES_PLATFORM_IMPORT
  #endif
#else
  #define XSEC_EXPORT __attribute__ ((visibility("default")))
#endif
