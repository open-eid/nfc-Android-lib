...
public final class LatviaIdemiaPersonalDataReplayTest {
    ...
    /**
     * Post-PACE personal data + cert read transcript, captured 2026-05-14.
     *
     * <p>Outcomes below are post-decrypt payloads — captured verbatim
     * from the logcat "Decrypted data:" lines, ISO 7816-4 padding included.
     * The shared replay reader strips the trailing 0x80 + 0x00* at call time.
     */
    static void loadPersonalDataTranscript(ApduReplayReader r) {
        ...
        r.expect("00a4040c10a000000077010800070000fe00000100", okPadded(""));
        // SELECT EF.AACE (auth cert) via P1=0x09, data=AD F1 34 01
        r.expect("00a4090c04adf13401", okPadded(""));

        // 6 chunked cert reads + terminating 6B00 EOF. Each chunk hex
        // is verbatim from the corresponding "Decrypted data" log line.
        r.expect("00b0000000", okPadded(
                ""));
        r.expect("00b000e700", okPadded(
                ""));
        r.expect("00b001ce00", okPadded(
                ""));
        r.expect("00b002b500", okPadded(
                ""));
        r.expect("00b0039c00", okPadded(
                ""));
        r.expect("00b0048300", okPadded(
                "3d971adbb02f44547a51a6061b4a603c5d16e3dac682f246c516aa8000000000"));
        // READ past EOF — SM-decrypted form translates to 6B00
